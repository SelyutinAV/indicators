"""
Django settings for indicators_project project.
...
PROJECT_ROOT = BASE_DIR.parent  # Корень всего проекта (models/)
...
WSGI_APPLICATION = 'indicators_project.wsgi.application'
...
STATIC_URL = 'static/'
STATIC_ROOT = PROJECT_ROOT / 'front' / 'staticfiles'
